...
public class ProductCommandsHandler {
    ...
    public void handleCommand(@Payload ReserveProductCommand command) {
        ...
        try {
            ...
            logger.error(e.getLocalizedMessage(), e); //si no hay suficiente stock, se produce una excepcion de producto cancelado para mandar un evento
    ...
    @KafkaHandler
    public void habdleCommand(@Payload CancelProductReservationCommand command){
