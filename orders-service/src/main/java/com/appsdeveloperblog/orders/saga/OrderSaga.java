...
public class OrderSaga {
    ...
    @KafkaHandler
    public void handlerEvent(@Payload ProductReservedEvent event){
    ...
    @KafkaHandler
    public void handlerEvent(@Payload PaymentProcessedEvent event){
    ...
    @KafkaHandler
    public void handlerEvent(@Payload ProductReservationCancelledEvent event){
